...
## 1) [Authenticate](https://runbuggy.docs.stoplight.io/reference/login/token/login)

## 2) [Create an Order](https://runbuggy.docs.stoplight.io/reference/orders/orders/createorderusingpost)
